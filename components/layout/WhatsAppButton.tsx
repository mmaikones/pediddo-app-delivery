...
export function WhatsAppButton({
    ...
    return (
        <a
            ...
            className="fixed bottom-24 right-4 z-40 w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full shadow-lg flex items-center justify-center transition-all hover:scale-110 group"
